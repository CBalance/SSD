...
class Learner(nn.Module):
    def __init__(self, inch):
        ...
        outch1, outch2, outch3 = 32, 128, 256
        ...
        # Decoder layers
        self.decoder = nn.Sequential(nn.Conv2d(outch3, outch3, (3, 3), padding=(1, 1), bias=True),
                                     nn.ReLU(),
    ...
    def forward(self, hypercorr_pyramid):
        ...
        logit_mask = self.decoder(hypercorr_encoded)
